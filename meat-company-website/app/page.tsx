        ...
        <div className="container">
          ...
          <div className="greeting-content">
            <div className="greeting-text">
              ...
              <p>
                「食育」の一助となれるよう、鮮度な原料仕入、職人による効率的な加工、徹底した製品の温度管理、自由便配送により、皆様の多様化したニーズにも対応できるよう柔軟に取り組んでまいります。そして、食べることの楽しさ、食べることの幸福感をたくさんの方々へお届けできるよう、その期待に応えることが企業使命だと考えています。
              </p>
              <p>
                これまで以上に、地域貢献を大切に、皆様の食生活をより豊かにできる企業であるよう努力を続けて参ります。今後ともより一層のご支援ご愛顧を賜りますようお願い申し上げます。
              </p>
        ...
        <div className="container">
          ...
          <div className="services-grid">
            ...
            <div className="service-card">
              ...
              <h3>給食部門</h3>
              <p>松戸市立小中学校、流山市立小中学校、保育所の給食用材料納入。</p>
            </div>
            <div className="service-card">
              <div className="service-icon">
                {/* 店舗販売アイコン */}
            ...
            <div className="service-card">
              ...
              <h3>自社便配送</h3>
              <p>
                松戸市、柏市、流山市近郊は、自社トラックでの配送を行っております。ご注文商品を工場で加工後に、素早く配送をさせていただきます。
                <br />
