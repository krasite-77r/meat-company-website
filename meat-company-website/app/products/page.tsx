          ...
          <div className="intro-content">
            <div className="intro-text">
              <p className="intro-main">
                ミートパッカー久慈では、国産・輸入「牛肉」「豚肉」「鶏肉」の精肉、挽肉、内臓など様々な部位に加え、ハム、ベーコン、ウィンナーなどの加工品も幅広く取り扱っております。
              </p>
            ...
            <div className="intro-features">
              <div className="feature-item">
                ...
                <div className="feature-text">
                  <h3>厳選された品質</h3>
                  <p>国産・輸入問わず、厳しい基準で選別した高品質な食肉のみを取り扱い</p>
                </div>
              </div>
              <div className="feature-item">
                <div className="feature-icon">
                ...
                <div className="feature-text">
                  <h3>用途別カット</h3>
                  <p>お客様のご要望に応じた部位カット・加工サービスを提供</p>
                </div>
              </div>
              <div className="feature-item">
                <div className="feature-icon">
